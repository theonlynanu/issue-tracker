...
(4, 1, 3,
    ...
    'Login button does not trigger any network request in Chrome 120',
    'BUG',
    'OPEN',
    'LOW',
    1, NULL),
...
(5, 1, 4,
	'Production outage - DB down',
    'Critical production outage due to DB connection pool exhaustion',
    'BUG',
    'RESOLVED',
    'CRITICAL',
    2, 2)
...
(5, 'As a viewer, I can still leave feedback - cool!', 1, 3)
;